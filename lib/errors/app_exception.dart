...
/// Raised when on-device OCR fails to process a receipt photo. Never
/// blocks the add-expense flow — callers catch this and fall back to
/// manual entry, since the whole point of the scan is convenience.
final class ReceiptScanException extends AppException {
  const ReceiptScanException(super.message, {super.cause});
}
